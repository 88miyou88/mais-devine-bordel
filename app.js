(() => {
  ...
  const MODE_ORDER = ["lyrics", "mime", "words"];
  ...
  const MODE_ICONS = {
    lyrics: `
      <svg viewBox="0 0 64 64" fill="none" aria-hidden="true">
        ...
        <circle cx="51" cy="16" r="2.2" fill="currentColor"/>
        <circle cx="56" cy="22" r="2.2" fill="currentColor" opacity=".75"/>
        <path d="m52 4 1.4 3.2L57 8.5l-3.6 1.3L52 13l-1.4-3.2L47 8.5l3.6-1.3L52 4Z" fill="currentColor"/>
      </svg>`,
    mime: `
      <svg viewBox="0 0 64 64" fill="none" aria-hidden="true">
        <path d="M17 17c4-9 24-12 34-1-9 0-17 2-25 7l-9-6Z" fill="currentColor"/>
        <path d="M24 17c-3 3-5 8-5 13 0 10 7 18 16 18s16-8 16-18c0-5-2-9-5-12" stroke="currentColor" stroke-width="4" stroke-linecap="round"/>
        <path d="M26 31c2 2 4 2 6 0M39 31c2 2 4 2 6 0M31 40c3 2 7 2 10 0" stroke="currentColor" stroke-width="3" stroke-linecap="round"/>
        <path d="M8 42c4-7 9-8 13-4l5 6M56 42c-4-7-9-8-13-4l-5 6" stroke="currentColor" stroke-width="4" stroke-linecap="round"/>
        <path d="M8 42 5 36M12 39 9 32M56 42l3-6M52 39l3-7" stroke="currentColor" stroke-width="2.5" stroke-linecap="round"/>
      </svg>`,
    words: `
      <svg viewBox="0 0 64 64" fill="none" aria-hidden="true">
