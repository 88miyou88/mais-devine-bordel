(() => {
  ...
  const el = {
    ...
    drawSupportPanel: document.querySelector("#drawSupportPanel"),
    ...
    drawReadyButton: document.querySelector("#drawReadyButton"),
  ...
  function showNextDrawingPrompt() {
    ...
    el.drawSupportPanel.classList.add("hidden");
  ...
  function showDrawingSupportChoice() {
    el.drawPromptPanel.classList.add("hidden");
    el.drawSupportPanel.classList.remove("hidden");
  }
  ...
  function startDrawingPlay(support) {
    ...
    round.eraser = false;
    el.drawEraserButton.classList.remove("active");
  ...
  function resizeDrawingCanvas(clear = false) {
    ...
    const round = state.drawRound;
    if (round) { round.canvasWidth = rect.width; round.canvasHeight = rect.height; if (clear) round.strokes = []; }
    redrawDrawingCanvas();
  }
  ...
  function toggleDrawEraser() {
    ...
    el.drawEraserButton.classList.toggle("active", state.drawRound.eraser);
  }

  function undoDrawingStroke() {
    if (!state.drawRound?.strokes.length) return;
    state.drawRound.strokes.pop();
    redrawDrawingCanvas();
  }

  function clearDrawingCanvas() {
    if (!state.drawRound) return;
    state.drawRound.strokes = [];
    redrawDrawingCanvas();
  }
  ...
  function bindEvents() {
    ...
    el.drawReadyButton.addEventListener("click", showDrawingSupportChoice);
